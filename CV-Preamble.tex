...
\par\end{center}\vspace{-1em}\par}

% Macro: body (rest of the document).
\newenvironment{body}
{\par\vspace{-1em}\par
\begin{longtable}{@{}p{0.2\columnwidth}@{\extracolsep{0.5em}}p{0.75\columnwidth}@{}}}
{\par\end{longtable}\par}

% Macro: section (new section for Education, Research Experience, etc.).
\renewcommand{\section}[3]{\\[-0.7em]\pdfbookmark[2]{#2}{#3}\\%
{\fontsize{11pt}{16pt}\selectfont\bfseries\raggedright%
\MakeUppercase{#1}}&}
...
{\par\begingroup\fontsize{12}{14}\selectfont}
{\par\endgroup\par}
...
\setlist[publication]{leftmargin=2em, labelsep=0.3em, itemsep=0em, widest*=100, topsep=0em, label={[\arabic*]}}

% Macro: Detail Item
\newlist{detailitem}{itemize}{1}
\setlist[detailitem]{itemsep=0em, topsep=0em, parsep=0em, leftmargin=1.5em, labelsep=0.4em, label=\textbullet}

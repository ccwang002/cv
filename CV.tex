...
\href{https://dbbs.wustl.edu/divprograms/compbio/Pages/default.aspx}
...
\begin{detailitem}
    ...
    \item Topic: Integrative analysis of copy number variation, gene expression, and miRNA regulation on cancer;
        drug treatment prediction on lung cancer cell line
\end{detailitem}
...
\begin{detail}
    \begin{detailitem}
    \item Advisor: Professor Eric Y. Chuang
    \item Topic: DNA-seq, RNA-seq and miRNA-seq data processing
    \item Project: Nextbiopy, a web-based NGS pipeline report generator
    \end{detailitem}
\end{detail}
...
\begin{detail}
    ...
    \item Improved Mandarin/Chinese text segmentation on ElasticSearch and added
